...
class CountryController extends AbstractController
{
    ...
    #[Route('/{IDCountry}', name: 'app_country_show', methods: ['GET'])]
    ...
    #[Route('/{IDCountry}/edit', name: 'app_country_edit', methods: ['GET', 'POST'])]
    ...
    #[Route('/{IDCountry}', name: 'app_country_delete', methods: ['POST'])]
